...
| `bots/` | `61-enemy`(enemyAI;**AI1 起只读自己的接触图**:`aiRedBelief` 四个来路 fix / brg / mem / search,状态在 `AIR`) | 决策 AI |
